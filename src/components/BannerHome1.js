...
const BannerHome = () => {
    ...
    const handleNext = () =>{
        if(currentImages < bannerData.length - 1){
                ...
                <div className='flex min-h-full max-h-[95vh] overflow-hidden '>
                    {
                        bannerData.map((data,index)=>{
                            ...
                            return (
                                <div className='min-w-full min-h-[450] lg:min-h-full overflow-hidden relative transition-all group' style={{transform:`translateX(-${currentImages*100}%)`}}>
